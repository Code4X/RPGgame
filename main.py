...
player3 = Person("Kali :", 3089, 174, 288, 34, player_spells, player_items)
...
print(bcolors.FAIL + bcolors.BOLD + "THE ENEMY YOU FOUND HAS ATTACKED. ATTACK BACK!" + bcolors.ENDC) #bcolors.ENDC ends the color of "AN ENEMY ATTACKS
